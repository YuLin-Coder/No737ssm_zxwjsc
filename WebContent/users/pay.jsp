					...
					<dl class="content">
						...
						<dd id="btn-dd">
							<span class="new-btn-login-sp">
								<button id="pay" class="new-btn-login" type="submit" style="text-align: center;">付 款</button> <input type="hidden" name="id"
								id="ordersid" value="${orders.ordersid}" /> <input type="hidden" name="basepath" id="basepath" value="<%=basePath%>" />
