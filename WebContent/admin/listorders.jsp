				...
				<c:forEach items="${ordersList}" var="orders">
					<tr class="text-c">
						...
						<td><c:if test="${orders.status eq '已付款'}">
								<a href="orders/status.action?id=${orders.ordersid }" title="发货">发货</a>&nbsp;&nbsp;</c:if><a
							href="orders/deleteOrders.action?id=${orders.ordersid}" onclick="{if(confirm('确定要删除吗?')){return true;}return false;}" title="删除"><i
