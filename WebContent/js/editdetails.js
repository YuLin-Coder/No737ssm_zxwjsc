$(function() {
	$('#btnUpdate').click(function() {// 保存按钮点击事件
		...
		var data = { "detailsid" : $("#detailsid").val(),"ordercode" : $("#ordercode").val(),"goodsid" : $("#goodsid").val(),"price" : $("#price").val(),"num" : $("#num").val()};
		var loc = $('#basepath').val();// 获取项目根目录
		var url = loc + "details/xupdateDetails.action";// 获取更新数据Controller地址
