$(function() {
	$('#btnUpdate').click(function() {// 保存按钮点击事件
		...
		var data = { "cartid" : $("#cartid").val(),"usersid" : $("#usersid").val(),"goodsid" : $("#goodsid").val(),"price" : $("#price").val(),"num" : $("#num").val(),"addtime" : $("#addtime").val()};
		var loc = $('#basepath').val();// 获取项目根目录
		var url = loc + "cart/xupdateCart.action";// 获取更新数据Controller地址
