...
public class ComplainsServiceImpl implements ComplainsService { // ComplainsServiceImpl 实现了 ComplainsService接口

	@Autowired // 它可以对类成员变量、方法及构造函数进行标注，完成自动装配的工作
	private ComplainsDAO complainsDAO; // 实现Spring的AOP依赖注入 自动注入AdminDAO接口
